...
const Page = () => {
  ...
  // state when user is fetching the messages
  const [isLoading, setIsLoading] = useState(false);
  // state when switch is being switched
  ...
  const handleDeleteMessage = async (messageId: string) => {
    ...
    // acceptMessagesis a form field whose value is being monitored
  ...
  const handleSwitchChange = async () => {
    try {
      ...
      const axiosError = error as AxiosError<ApiResponse>;
      toast.error(axiosError.response?.data.message || "An error occurred while updating preferences.");
